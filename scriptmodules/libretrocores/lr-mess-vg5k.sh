...
rp_module_id="lr-mess-vg5000"
rp_module_name="Philips VG-5000"
rp_module_ext=".zip .k7"
...
vg5k.zip\n\n
How to load games:\n
type CLOAD<enter>, SCRLK->Tape Control->Play, SCRLK again"

rp_module_licence="GPL2 https://raw.githubusercontent.com/libretro/mame/master/LICENSE.md"
rp_module_section="exp"
rp_module_flags=""

function depends_lr-mess-vg5000() {
...
function sources_lr-mess-vg5000() {
	true
}

function build_lr-mess-vg5000() {
	true
}

function install_lr-mess-vg5000() {
	true
}

function configure_lr-mess-vg5000() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
	local _retroarch_bin="$rootdir/emulators/retroarch/bin/retroarch"
	local _system="vg5000"
	...
	addEmulator 1 "$md_id" "$_system" "$_script $_retroarch_bin $_mess $_config vg5k $biosdir -cass %ROM%"
