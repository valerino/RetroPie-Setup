...
rp_module_id="lr-mess-mo5"
rp_module_name="Thomson MO5"
...
To load cartridges, you have use runcommand and choose the -cart option\n\n"

rp_module_licence="GPL2 https://raw.githubusercontent.com/libretro/mame/master/LICENSE.md"
rp_module_section="exp"
rp_module_flags=""

function depends_lr-mess-mo5() {
...
function sources_lr-mess-mo5() {
	true
}

function build_lr-mess-mo5() {
	true
}

function install_lr-mess-mo5() {
	true
}

function configure_lr-mess-mo5() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
