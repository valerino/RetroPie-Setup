...
rp_module_id="lr-mess-megaduck"
rp_module_name="Mega Duck"
...
function depends_lr-mess-megaduck() {
...
function sources_lr-mess-megaduck() {
	true
}

function build_lr-mess-megaduck() {
	true
}

function install_lr-mess-megaduck()  {
	true
}

function configure_lr-mess-megaduck() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
	local _retroarch_bin="$rootdir/emulators/retroarch/bin/retroarch"
	local _system="megaduck"
