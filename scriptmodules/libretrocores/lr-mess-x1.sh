...
rp_module_ext=".dx1 .zip .2d .2hd .tfd .d88 .88d .hdm .xdf .dup .cmd .DX1 .ZIP .2D .2HD .TFD .D88 .88D .HDM .XDF .DUP .CMD"
...
function sources_lr-mess-x1() {
	true
}

function build_lr-mess-x1() {
	true
}

function install_lr-mess-x1() {
	true
}

function configure_lr-mess-x1() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
