...
rp_module_id="lr-mess-to8"
rp_module_name="Thomson TO8"
rp_module_ext=".zip .sap"
...
function sources_lr-mess-to8() {
	true
}

function build_lr-mess-to8() {
	true
}

function install_lr-mess-to8() {
	true
}

function configure_lr-mess-to8() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
