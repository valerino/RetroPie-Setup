...
rp_module_id="lr-mess-cdi"
rp_module_name="Philips CD-i"
rp_module_ext=".chd"
...
function sources_lr-mess-cdi() {
	true
}

function build_lr-mess-cdi() {
	true
}

function install_lr-mess-cdi() {
	true
}

function configure_lr-mess-cdi() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
