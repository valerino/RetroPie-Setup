...
rp_module_id="lr-mess-apfm1000"
rp_module_name="APF M1000 - The Imagination Machine"
...
function depends_lr-mess-apfm1000() {
...
function sources_lr-mess-apfm1000() {
	true
}

function build_lr-mess-apfm1000() {
	true
}

function install_lr-mess-apfm1000() {
	true
}

function configure_lr-mess-apfm1000() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
	local _retroarch_bin="$rootdir/emulators/retroarch/bin/retroarch"
	local _system="apfm1000"
