...
rp_module_id="lr-mess-scv"
rp_module_name="EPOCH Super Cassette Vision"
...
Put games in:\n
$romdir/scv\n\n
Watch out for correct joypad remapping if you have a keyboard without numpad!"

rp_module_licence="GPL2 https://raw.githubusercontent.com/libretro/mame/master/LICENSE.md"
rp_module_section="exp"
rp_module_flags=""

function depends_lr-mess-scv() {
...
function sources_lr-mess-scv() {
	true
}

function build_lr-mess-scv() {
	true
}

function install_lr-mess-scv() {
	true
}

function configure_lr-mess-scv() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
