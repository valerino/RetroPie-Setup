...
rp_module_id="lr-mess-mz700"
rp_module_name="Sharp MZ-700"
rp_module_ext=".zip .m12 .mzf .mzt"
...
function depends_lr-mess-mz700() {
...
function sources_lr-mess-mz700() {
	true
}

function build_lr-mess-mz700() {
	true
}

function install_lr-mess-mz700()  {
	true
}

function configure_lr-mess-mz700() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
