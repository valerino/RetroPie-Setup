...
rp_module_id="lr-mess-pv1000"
rp_module_name="Casio PV-1000"
...
function depends_lr-mess-pv1000() {
...
function sources_lr-mess-pv1000() {
	true
}

function build_lr-mess-pv1000() {
	true
}

function install_lr-mess-pv1000() {
	true
}

function configure_lr-mess-pv1000() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
	local _retroarch_bin="$rootdir/emulators/retroarch/bin/retroarch"
	local _system="pv1000"
