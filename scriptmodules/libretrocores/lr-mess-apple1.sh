...
rp_module_id="lr-mess-apple1"
rp_module_name="Apple I"
rp_module_ext=".zip .wav"
...
function depends_lr-mess-apple1() {
...
function sources_lr-mess-apple1() {
	true
}

function build_lr-mess-apple1() {
	true
}

function install_lr-mess-apple1()  {
	true
}

function configure_lr-mess-apple1() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
	local _retroarch_bin="$rootdir/emulators/retroarch/bin/retroarch"
	local _system="apple1"
