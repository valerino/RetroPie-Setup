...
rp_module_id="lr-mess-supervision"
rp_module_name="Watara Super Vision"
...
function depends_lr-mess-supervision() {
...
function sources_lr-mess-supervision() {
	true
}

function build_lr-mess-supervision() {
	true
}

function install_lr-mess-supervision()  {
	true
}

function configure_lr-mess-supervision() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
	local _retroarch_bin="$rootdir/emulators/retroarch/bin/retroarch"
	local _system="supervision"
