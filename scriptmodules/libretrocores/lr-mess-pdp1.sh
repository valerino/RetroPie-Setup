...
rp_module_id="lr-mess-pdp1"
rp_module_name="Digital Equipment Corporation PDP-1"
rp_module_ext=".zip .tap .rim"
...
function sources_lr-mess-pdp1() {
	true
}

function build_lr-mess-pdp1() {
	true
}

function install_lr-mess-pdp1() {
	true
}

function configure_lr-mess-pdp1() {
	local _mess=$(dirname "$md_inst")/lr-mess/mess_libretro.so
	...
	addEmulator 1 "$md_id" "$_system" "$_script $_retroarch_bin $_mess $_config pdp1 $biosdir -ptap1 %ROM%"
